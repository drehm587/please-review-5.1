...
{
    alert("Agent, click on the button for additional details!")
...
//make function linked to the mp3 file I'm using
function Details()
{
    mySound = new sound("Agent Details.mp3");
    mySound.play();
}
...
//this will use the reload webpage type function that you showed us in the demo. I felt this was easier to understand and utilize so i decided on this way
